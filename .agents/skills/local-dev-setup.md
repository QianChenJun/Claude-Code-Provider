...
description: 初始化 AI CLI Switcher 本地开发环境，检查依赖、配置供应商、同步快捷命令
...
自动打开浏览器访问 `http://127.0.0.1:15723/auth?token=xxx&tool=claude`
...
2. 检查端口占用: `Get-NetTCPConnection -LocalPort 15723 -ErrorAction SilentlyContinue`
